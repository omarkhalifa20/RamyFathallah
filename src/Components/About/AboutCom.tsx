  ...
  return (
    ...
    <div className='container mx-auto w-[95%]  lg:w-[90%] py-15'>
       <div className='box-Shad2 bg-[#0000007c] grid grid-cols-12 items-center py-12 px-7 border-2 border-[#49e3de] rounded-4xl'>
         ...
         <h2 className="ArefRuqaa text-[35px] lg:text-[45px] 2xl:text-[70px] absolute left-[50%] translate-x-[-50%]  bottom-0 text-Shad z-31 text-[#fff] ">رامي فتح الله</h2> 
          </div>
...
أعمل كمراقب حسابات للشركات المساهمة المصرية، وأنا عضو في عدد من الجهات المهنية مثل</p> 
            <div className='grid grid-cols-12 gap-y-7 gap-x-3'>
               <div className=' col-span-12 lg:col-span-6 2xl:col-span-4 gap-x-2 py-2 flex justify-end bg-gradiant3 rounded-xl items-center'>
               ...
               <div className='col-span-12 lg:col-span-6 2xl:col-span-4 flex gap-x-5 justify-end bg-gradiant2 rounded-xl items-center'>
               <p className='Lalezar outline-text text-[#fff] text-[14px]'>عضو بمجلس اداره نادي سموحه</p>
               <img className=" w-[41px] " src="/smouha.webp" />
               </div>
               <div className='col-span-12 lg:col-span-6 2xl:col-span-4 flex justify-end bg-gradiant rounded-xl items-center'>
               ...
               <div className='col-span-12 lg:col-span-6 2xl:col-span-4 flex gap-2 justify-end bg-gradiant4 rounded-xl items-center'>
               ...
               <div className='col-span-12 lg:col-span-6 2xl:col-span-4 gap-2 py-2 flex justify-end bg-gradiant5 rounded-xl items-center'>
               ...
               <div className='col-span-12 lg:col-span-6 2xl:col-span-4 flex justify-end gap-6 bg-gradiant6 rounded-xl items-center'>
